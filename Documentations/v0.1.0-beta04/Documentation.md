...
Before diving into coding, ensure you have TPL properly installed on your system. Refer to the detailed [installation guide](https://github.com/Tanish-Ranjan/TPL#installation).
...
**Running the Script:**
Once you have created a TPL script (e.g., `hello.tpl`), you can execute it using the TPL interpreter. The specific command depends on your chosen installation method (VS Code extension or command line). Refer to the [installation guide](https://github.com/Tanish-Ranjan/TPL#installation) for detailed instructions.
...
- Avoid reserved keywords: Reserved keywords are special words that have predefined meanings in TPL. You cannot use reserved keywords as identifiers because they have specific functionalities within the language. (Refer to the advanced documentation for a list of reserved keywords).
...
By effectively using variables, you can write flexible and reusable TPL programs.

## 3\. Data Types
TPL supports various data types to represent different kinds of information:

- Numbers: Represent numeric values (e.g., integers, floating-point numbers). You can perform calculations using these data types.
- Strings: Represent textual data enclosed in quotation marks (e.g., `"Hello, world!"`).
- Booleans: Represent logical values (`true` or `false`). These are useful for making decisions based on conditions.
...
By effectively utilizing functions, you can create well-structured and maintainable TPL applications. The next section will delve into Object-Oriented Programming (OOP) concepts in TPL.
...
**Syntax:**
```tpl
class ClassName (arguments) { // constructor for initializing objects
...
> [!NOTE]
> This section provides a basic introduction to OOP in TPL. A dedicated section for advanced topics (linked from here) can delve deeper into inheritance, polymorphism, and other advanced OOP concepts.
...
**Remember:**
- Consult the advanced documentation for a complete reference of built-in classes and functions.
- Each built-in element typically has detailed documentation explaining its usage and available methods.
